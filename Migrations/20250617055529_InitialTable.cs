        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CompanyName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PhotographerFirstName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PhotographerLastName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AvatarUrl = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AgentPhotographers", x => new { x.AgentId, x.PhotographerId });
                    table.ForeignKey(
                        name: "FK_AgentPhotographers_Agents_AgentId",
                        column: x => x.AgentId,
                        principalTable: "Agents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AgentPhotographers_PhotographyCompanies_PhotographerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AgentPhotographers_PhotographerId",
                table: "AgentPhotographers",
